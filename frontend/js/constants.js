...
const welcome_h1 = "Welcome to the LolBatz NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'LOLBatz NFT Project is a small collection size of 5555 bats ready to leave their cave!';
const h1_presale_coming_soon = "NFT Drop Landing Soon!!";
